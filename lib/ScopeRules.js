...
class ScopeRules {
	...
	scopeExpression(scopeStart, scopeArguments, controlCode) {
		...
		return self.sn(['scope.createScope((args)=>{', 'const __oldthis__ = scope.thisObj;', 'scope.setForeignThis(this);', argDeclarations, controlCode, 'scope.setForeignThis(__oldthis__);', "})"]);
	}
