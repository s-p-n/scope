...
var $$$4 = $primitive('Text', function() {
    return "Is foo the number 10?"
}.bind($root));
var $$$5 = $primitive('Number', function() {
    return 10
}.bind($root));
var $$$6 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$4, $compare(this.$self("foo", 3), $$$5)))
}.bind($root);
var $$$7 = $primitive('Text', function() {
    return "foo is "
}.bind($root));
var $$$8 = function() {
    return (Text.$values["Scope"]()(this.$self("foo", 4)))
}.bind($root);
var $$$9 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($concat($$$7, $$$8(), 4)))
}.bind($root);
...
var $$$13 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($concat($$$12, this.$self("bar", 9), 9)))
}.bind($root);
var $$$14 = $primitive('Text', function() {
    return "foo is now:"
}.bind($root));
var $$$15 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$14, this.$self("foo", 10)))
...
$$$6();
$$$9();
$root.$self("public", "bar", $$$10);
$root.$self("var", "foo", $$$11);
$$$13();
$$$15();