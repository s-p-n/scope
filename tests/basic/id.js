...
var $$$6 = function() {
    return (Console.write.$values["Scope"]()($$$4, $compare(this.$self("foo"), $$$5)))
}.bind($root);
...
var $$$9 = function() {
    return (Console.write.$values["Scope"]()($concat($$$7, $$$8(), 4)))
}.bind($root);
...
var $$$13 = function() {
    return (Console.write.$values["Scope"]()($concat($$$12, this.$self("bar"), 9)))
}.bind($root);
var $$$14 = $primitive('Text', function() {
    return "foo is now:"
}.bind($root));
var $$$15 = function() {
    return (Console.write.$values["Scope"]()($$$14, this.$self("foo")))
