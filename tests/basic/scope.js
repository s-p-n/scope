    ...
    return ( /* Starting Scope:1 */ $primitive("Scope", function() {
        return function() {
            var $returnMulti = [],
                $temp, $val;
            var $$$0 = function() {
                return (Console.$values["Instance"]().write.$values["Scope"]()(this.$self("some", 3), this.$self("args", 3), this.$self("here", 3)))
            }.bind(this);
            var $$$1 = $primitive('Text', function() {
                return ""
            }.bind(this));
...
var $$$4 = function() {
    return (this.$self("Foo", 16).$values["Scope"]()())
}.bind($root);
var $$$5 = $primitive('Text', function() {
    return "foo is an"
}.bind($root));
var $$$6 = function() {
    return (Type.$values["Scope"]()(this.$self("foo", 17)))
}.bind($root);
var $$$7 = $primitive('Text', function() {
    return "of Foo."
}.bind($root));
var $$$8 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$5, $$$6(), $$$7))
}.bind($root);
var $$$9 = $primitive('Text', function() {
    return "foo.baz is:"
}.bind($root));
var $$$10 = function() {
    return (this.$self("foo", 19).$values["Instance"]().$self("getBaz").$values["Scope"]()())
}.bind($root);
var $$$11 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$9, $$$10()))
