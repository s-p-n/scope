        ...
        return function() {
            ...
            this.$self("public", "move", /* Starting Scope:2 */ $primitive("Scope", function() {
                return function() {
                    ...
                    var $$$1 = function() {
                        return (Console.$values["Instance"]().write.$values["Scope"]()($$$0))
                    }.bind(this);
...
var $$$3 = function() {
    return (this.$self("Snake", 20).$values["Scope"]()($$$2))
}.bind($root);
var $$$4 = function() {
    return (this.$self("sam", 21).$values["Instance"]().$self("move").$values["Scope"]()())
}.bind($root);
var $$$5 = $primitive('Text', function() {
    return 'Tommy the Palomino'
}.bind($root));
var $$$6 = function() {
    return (this.$self("Horse", 23).$values["Scope"]()($$$5))
}.bind($root);
var $$$7 = function() {
    return (this.$self("tom", 24).$values["Instance"]().$self("move").$values["Scope"]()())
    ...
    return function() {
        ...
        this.$self("protected", "move", /* Starting Scope:2 */ $primitive("Scope", function() {
            return function() {
                ...
                var $$$3 = function() {
                    return (Console.$values["Instance"]().write.$values["Scope"]()($concat($concat($concat(this.$parent.$values["Instance"]().$self("name"), $$$0, 3), $$$1(), 3), $$$2, 3)))
                }.bind(this);
