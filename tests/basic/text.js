...
var $$$1 = function() {
    return (Console.write.$values["Scope"]()(this.$self("msg")))
}.bind($root);
var $$$2 = function() {
    return (Console.read.$values["Scope"]()( /* Starting Scope:1 */ $primitive("Scope", function() {
        return function() {
            var $returnMulti = [],
                $temp;
            ...
            $$$1 = function() {
                return (Console.write.$values["Scope"]()($$$0, this.$self("name")))
            }.bind(this);
            $$$2 = $primitive('Text', function() {
                return ""
            }.bind(this));
            this.$arg("name", "$$$2", arguments[0]);
            /* Begin ControlCode: 1 */
            $$$1();
