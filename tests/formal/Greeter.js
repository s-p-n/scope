...
var $$$1 = function() {
    return (this.$self("Greeter", 6).$values["Scope"]()($$$0))
}.bind($root);
...
var $$$4 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$2, $$$3))
}.bind($root);
var $$$5 = $primitive('Text', function() {
    return "Test:"
}.bind($root));
var $$$6 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$5))
}.bind($root);
var $$$7 = function() {
    return (this.$self("g", 9).$values["Instance"]().$self("salute").$values["Scope"]()())
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "Greeter", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp, $val;
        var $$$0 = $primitive('Text', function() {
        ...
        /* Begin ControlCode: 1 */
        this.$self("public", "salute", /* Starting Scope:2 */ $primitive("Scope", function() {
            return function() {
                var $returnMulti = [],
                    $temp, $val;
                var $$$0 = $primitive('Text', function() {
                ...
                var $$$2 = function() {
                    return (Console.$values["Instance"]().write.$values["Scope"]()($concat($concat($$$0, this.$parent.$values["Instance"]().$self("name"), 3), $$$1, 3)))
                }.bind(this);
                /* Begin ControlCode: 2 */
                $$$2();
