...
var $$$15 = $primitive('Boolean', function() {
    return true
}.bind($root));
var $$$16 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$14, $$$15))
}.bind($root);
...
var $$$20 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$17, $primitive("Boolean", function(val) {
        return function() {
            return val;
        }
    }($$$18.$values["Number"]() < $$$19.$values["Number"]()))))
}.bind($root);
...
var $$$23 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$21, $$$22))
}.bind($root);
var $$$24 = $primitive('Text', function() {
    return "Test:"
}.bind($root));
...
var $$$27 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$24, $primitive("Boolean", function(val) {
        return function() {
            return val;
        }
    }($$$25.$values["Number"]() <= $$$26.$values["Number"]()))))
}.bind($root);
var $$$28 = $primitive('Text', function() {
    return "Expect:"
}.bind($root));
var $$$29 = $primitive('Boolean', function() {
    return false
}.bind($root));
var $$$30 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$28, $$$29))
}.bind($root);
var $$$31 = $primitive('Text', function() {
    return "Test:"
}.bind($root));
var $$$32 = $primitive('Number', function() {
    return 1
}.bind($root));
var $$$33 = $primitive('Number', function() {
    return 2
}.bind($root));
var $$$34 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$31, $primitive("Boolean", function(val) {
        return function() {
            return val;
        }
    }($$$32.$values["Number"]() > $$$33.$values["Number"]()))))
}.bind($root);
var $$$35 = $primitive('Text', function() {
    return "Expect:"
}.bind($root));
var $$$36 = $primitive('Boolean', function() {
    return false
}.bind($root));
var $$$37 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$35, $$$36))
}.bind($root);
var $$$38 = $primitive('Text', function() {
    return "Test:"
}.bind($root));
var $$$39 = $primitive('Number', function() {
    return 1
}.bind($root));
var $$$40 = $primitive('Number', function() {
    return 2
}.bind($root));
var $$$41 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$38, $primitive("Boolean", function(val) {
        return function() {
            return val;
        }
    }($$$39.$values["Number"]() >= $$$40.$values["Number"]()))))
