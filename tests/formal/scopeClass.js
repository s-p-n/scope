...
var $$$0 = function() {
    return (this.$self("Foo", 7).$values["Scope"]()())
}.bind($root);
...
var $$$3 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$1, $$$2))
}.bind($root);
var $$$4 = $primitive('Text', function() {
    return "Test:"
}.bind($root));
var $$$5 = function() {
    return (this.$self("foo", 9).$values["Instance"]().$self("getBar").$values["Scope"]()())
}.bind($root);
var $$$6 = function() {
    return (Console.$values["Instance"]().write.$values["Scope"]()($$$4, $$$5()))
