...
var $$$1 = function() {
    return (this.$self("stringSplosion", 14).$values["Scope"]()($$$0))
}.bind($root);
var $$$2 = function() {
...
var $$$4 = function() {
    return (this.$self("stringSplosion", 15).$values["Scope"]()($$$3))
}.bind($root);
var $$$5 = function() {
...
var $$$7 = function() {
    return (this.$self("stringSplosion", 16).$values["Scope"]()($$$6))
}.bind($root);
var $$$8 = function() {
    return (print.$values["Scope"]()($$$7()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "stringSplosion", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp, $val;
        ...
        var $$$2 = function() {
            return (len.$values["Scope"]()(this.$self("str", 8)))
        }.bind(this);
        ...
        (function() {
            ...
            }(this.$self("i", 8).$values["Number"]() < $$$2().$values["Number"]())).$values["Boolean"]()) {
                (function() {
                    return (function(val) {
                        this.$self("result", 9).$types = Object.create(val.$types);
                        this.$self("result", 9).$values = Object.create(val.$values);
                        return this.$self("result", 9);
                    }.call(this, $concat(this.$self("result", 9), this.$self("str", 9).$substr(0, (function() {
                        this.$self("i", 9).$values["Number"] = function(val) {
                            return function() {
                                return val;
                            }
                        }(this.$self("i", 9).$values["Number"]() + $$$3.$values["Number"]());
                        return this.$self("i", 9);
                    }.call(this)).$values["Number"]()), 9)));;
        ...
        $returnMulti.push(this.$self("result", 11));
        var $i = 0,
            $j = 0,
