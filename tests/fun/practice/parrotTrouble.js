...
var $$$2 = function() {
    return (this.$self("parrotTrouble", 11).$values["Scope"]()($$$0, $$$1))
}.bind($root);
var $$$3 = function() {
...
var $$$6 = function() {
    return (this.$self("parrotTrouble", 12).$values["Scope"]()($$$4, $$$5))
}.bind($root);
var $$$7 = function() {
...
var $$$10 = function() {
    return (this.$self("parrotTrouble", 13).$values["Scope"]()($$$8, $$$9))
}.bind($root);
var $$$11 = function() {
...
var $$$14 = function() {
    return (this.$self("parrotTrouble", 14).$values["Scope"]()($$$12, $$$13))
}.bind($root);
var $$$15 = function() {
...
var $$$18 = function() {
    return (this.$self("parrotTrouble", 15).$values["Scope"]()($$$16, $$$17))
}.bind($root);
var $$$19 = function() {
...
$root.$self("var", "parrotTrouble", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        ...
        }(this.$self("talking", 8).$values["Boolean"]() && ($primitive("Boolean", function(val) {
            return function() {
                return val;
            }
        ...
        }(this.$self("hour", 8).$values["Number"]() < $$$0.$values["Number"]())).$values["Boolean"]() || $primitive("Boolean", function(val) {
            return function() {
                return val;
            }
        }(this.$self("hour", 8).$values["Number"]() > $$$1.$values["Number"]())).$values["Boolean"]()))).$values["Boolean"]())));
        var $i = 0,
            $j = 0,
