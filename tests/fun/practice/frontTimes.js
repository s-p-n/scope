...
var $$$2 = function() {
    return (this.$self("frontTimes", 10).$values["Scope"]()($$$0, $$$1))
}.bind($root);
var $$$3 = function() {
...
var $$$6 = function() {
    return (this.$self("frontTimes", 11).$values["Scope"]()($$$4, $$$5))
}.bind($root);
var $$$7 = function() {
...
var $$$10 = function() {
    return (this.$self("frontTimes", 12).$values["Scope"]()($$$8, $$$9))
}.bind($root);
var $$$11 = function() {
    return (print.$values["Scope"]()($$$10()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "frontTimes", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp, $val;
        ...
        var $$$3 = function() {
            return (len.$values["Scope"]()(this.$self("str", 4)))
        }.bind(this);
        var $$$4 = function() {
            return (len.$values["Scope"]()(this.$self("result", 4)))
        }.bind(this);
        ...
        this.$arg("str", "$$$5", arguments[0]);
        this.$arg("n", "$$$6", arguments[1]);
        /* Begin ControlCode: 1 */
        (function() {
            this.$self("str", 2).$types = this.$self("str", 2).$substr($$$0.$values["Number"](), $$$1.$values["Number"]()).$types;
            this.$self("str", 2).$values = this.$self("str", 2).$substr($$$0.$values["Number"](), $$$1.$values["Number"]()).$values;
            return this.$self("str", 2);
        }.call(this));
        this.$self("var", "result", $$$2);
        (function() {
            while ($primitive("Boolean", function(val) {
                return function() {
                    return val;
                }
            }(($Math.multiply($$$3(), this.$self("n", 4))).$values["Number"]() > $$$4().$values["Number"]())).$values["Boolean"]()) {
                (function() {
                    return (function(val) {
                        this.$self("result", 5).$types = Object.create(val.$types);
                        this.$self("result", 5).$values = Object.create(val.$values);
                        return this.$self("result", 5);
                    }.call(this, $concat(this.$self("result", 5), this.$self("str", 5), 5)));;
        ...
        $returnMulti.push(this.$self("result", 7));
        var $i = 0,
            $j = 0,
