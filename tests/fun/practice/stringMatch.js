...
var $$$2 = function() {
    return (this.$self("stringMatch", 24).$values["Scope"]()($$$0, $$$1))
}.bind($root);
var $$$3 = function() {
...
var $$$6 = function() {
    return (this.$self("stringMatch", 25).$values["Scope"]()($$$4, $$$5))
}.bind($root);
var $$$7 = function() {
...
var $$$10 = function() {
    return (this.$self("stringMatch", 26).$values["Scope"]()($$$8, $$$9))
}.bind($root);
var $$$11 = function() {
    return (print.$values["Scope"]()($$$10()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "stringMatch", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp, $val;
        var $$$0 = $primitive('Text', function() {
        ...
        var $$$2 = function() {
            return (len.$values["Scope"]()(this.$self("b", 11)))
        }.bind(this);
        var $$$3 = function() {
            return (len.$values["Scope"]()(this.$self("a", 11)))
        }.bind(this);
        ...
        this.$arg("a", "$$$8", arguments[0]);
        this.$arg("b", "$$$9", arguments[1]);
        /* Begin ControlCode: 1 */
        this.$self("var", "c", $$$0);
        ...
        (function() {
            ...
            }($$$2().$values["Number"]() < $$$3().$values["Number"]())).$values["Boolean"]()) {
                return (function() {
                    (function() {
                        this.$self("c", 12).$types = this.$self("a", 12).$types;
                        this.$self("c", 12).$values = this.$self("a", 12).$values;
                        return this.$self("c", 12);
                    }.call(this));
                    (function() {
                        this.$self("a", 13).$types = this.$self("b", 13).$types;
                        this.$self("a", 13).$values = this.$self("b", 13).$values;
                        return this.$self("a", 13);
                    }.call(this));
                    return (function() {
                        this.$self("b", 14).$types = this.$self("c", 14).$types;
                        this.$self("b", 14).$values = this.$self("c", 14).$values;
                        return this.$self("b", 14);
                    }.call(this));;;;
        ...
        (function() {
            ...
            var $$$list = this.$self("a", 16).$substr(0, $primitive("Number", function(value) {
                return function() {
                    return value;
                }
            }(-$$$4.$values["Number"]())).$values["Number"]());
            if ($$$list.$types.indexOf("Array") !== -1) {
                $$$list = $$$list.$values.Array();
            } else if ($$$list.$types.indexOf("Instance") !== -1) {
                $$$list = $$$list.$values.Instance();
            } else if ($$$list.$types.indexOf("Text") !== -1) {
                $$$list = $$$list.$values.Text();
            } else {
                $$$list = [];
            }
            ...
            for (i in $$$list) {
                ...
                if ($$$list.hasOwnProperty(i)) {
                    (function() {
                        return (function() {
                            if ($compare(this.$self("a", 17).$substr(this.$self("i", 17).$values["Number"](), $Math.add(this.$self("i", 17), $$$5).$values["Number"]()), this.$self("b", 17).$substr(this.$self("i", 17).$values["Number"](), $Math.add(this.$self("i", 17), $$$6).$values["Number"]())).$values["Boolean"]()) {
                                return (function() {
                                    return (function() {
                                        this.$self("result", 18).$values["Number"] = function(val) {
                                            return function() {
                                                return val;
                                            }
                                        }(this.$self("result", 18).$values["Number"]() + $$$7.$values["Number"]());
                                        return this.$self("result", 18);
                                    }.call(this));;
        ...
        $returnMulti.push(this.$self("result", 21));
        var $i = 0,
            $j = 0,
