...
var $$$2 = function() {
    return (this.$self("makes10", 9).$values["Scope"]()($$$0, $$$1))
}.bind($root);
var $$$3 = function() {
...
var $$$6 = function() {
    return (this.$self("makes10", 10).$values["Scope"]()($$$4, $$$5))
}.bind($root);
var $$$7 = function() {
...
var $$$10 = function() {
    return (this.$self("makes10", 11).$values["Scope"]()($$$8, $$$9))
}.bind($root);
var $$$11 = function() {
...
var $$$14 = function() {
    return (this.$self("makes10", 12).$values["Scope"]()($$$12, $primitive("Number", function(value) {
        return function() {
            return value;
        }
    }(-$$$13.$values["Number"]()))))
...
$root.$self("var", "makes10", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp, $val;
        var $$$0 = $primitive('Number', function() {
        ...
        this.$arg("a", "$$$3", arguments[0]);
        this.$arg("b", "$$$4", arguments[1]);
        /* Begin ControlCode: 1 */
        ...
        }($compare(this.$self("a", 6), $$$0).$values["Boolean"]() || $compare(this.$self("b", 6), $$$1).$values["Boolean"]())).$values["Boolean"]() || $compare($Math.add(this.$self("a", 6), this.$self("b", 6)), $$$2).$values["Boolean"]())));
        var $i = 0,
            $j = 0,
