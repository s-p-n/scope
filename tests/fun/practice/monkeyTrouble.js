...
var $$$2 = function() {
    return (this.$self("monkeyTrouble", 11).$values["Scope"]()($$$0, $$$1))
}.bind($root);
var $$$3 = function() {
...
var $$$6 = function() {
    return (this.$self("monkeyTrouble", 12).$values["Scope"]()($$$4, $$$5))
}.bind($root);
var $$$7 = function() {
...
var $$$10 = function() {
    return (this.$self("monkeyTrouble", 13).$values["Scope"]()($$$8, $$$9))
}.bind($root);
var $$$11 = function() {
...
var $$$14 = function() {
    return (this.$self("monkeyTrouble", 14).$values["Scope"]()($$$12, $$$13))
}.bind($root);
var $$$15 = function() {
...
$root.$self("var", "monkeyTrouble", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        ...
        $returnMulti.push($compare(this.$self("aSmile", 8), this.$self("bSmile", 8)));
        var $i = 0,
            $j = 0,
