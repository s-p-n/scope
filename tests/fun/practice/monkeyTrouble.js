...
var $$$2 = function() {
    return (this.$self("monkeyTrouble").$values["Scope"]()($$$0, $$$1))
}.bind($root);
var $$$3 = function() {
...
var $$$5 = $primitive('Boolean', function() {
    return false
}.bind($root));
var $$$6 = function() {
    return (this.$self("monkeyTrouble").$values["Scope"]()($$$4, $$$5))
}.bind($root);
var $$$7 = function() {
...
var $$$9 = $primitive('Boolean', function() {
    return false
}.bind($root));
var $$$10 = function() {
    return (this.$self("monkeyTrouble").$values["Scope"]()($$$8, $$$9))
}.bind($root);
var $$$11 = function() {
...
var $$$13 = $primitive('Boolean', function() {
    return true
}.bind($root));
var $$$14 = function() {
    return (this.$self("monkeyTrouble").$values["Scope"]()($$$12, $$$13))
}.bind($root);
var $$$15 = function() {
    return (print.$values["Scope"]()($$$14()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "monkeyTrouble", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp;
        $$$0 = $primitive('Boolean', function() {
            return false
        }.bind(this));
        $$$1 = $primitive('Boolean', function() {
            return false
        }.bind(this));
        this.$arg("aSmile", "$$$0", arguments[0]);
        this.$arg("bSmile", "$$$1", arguments[1]);
        /* Begin ControlCode: 1 */
        if (typeof $returnMulti === "undefined") {
            var $returnMulti = [];
        }
        $returnMulti.push($compare(this.$self("aSmile"), this.$self("bSmile")));
        var $i = 0,
            $j = 0,
