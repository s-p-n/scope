...
var $$$3 = function() {
    return (this.$self("arrayCount9", 15).$values["Scope"]()($array([$$$0, $$$1, $$$2])))
}.bind($root);
var $$$4 = function() {
...
var $$$8 = function() {
    return (this.$self("arrayCount9", 16).$values["Scope"]()($array([$$$5, $$$6, $$$7])))
}.bind($root);
var $$$9 = function() {
...
var $$$15 = function() {
    return (this.$self("arrayCount9", 17).$values["Scope"]()($array([$$$10, $$$11, $$$12, $$$13, $$$14])))
}.bind($root);
var $$$16 = function() {
    return (print.$values["Scope"]()($$$15()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "arrayCount9", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp, $val;
        var $$$0 = $primitive('Number', function() {
        ...
        (function() {
            ...
            var name, $$$list = this.$self("nums", 7).$values["Array"]();
            for (index in $$$list) {
                ...
                if ($$$list.hasOwnProperty(index)) {
                    ...
                    (function() {
                        return (function() {
                            if ($compare(this.$self("value", 8), $$$1).$values["Boolean"]()) {
                                return (function() {
                                    return (function() {
                                        this.$self("result", 9).$values["Number"] = function(val) {
                                            return function() {
                                                return val;
                                            }
                                        }(this.$self("result", 9).$values["Number"]() + $$$2.$values["Number"]());
        ...
        $returnMulti.push(this.$self("result", 12));
        var $i = 0,
            $j = 0,
