...
var $$$1 = function() {
    return (this.$self("frontBack", 13).$values["Scope"]()($$$0))
}.bind($root);
var $$$2 = function() {
...
var $$$4 = function() {
    return (this.$self("frontBack", 14).$values["Scope"]()($$$3))
}.bind($root);
var $$$5 = function() {
...
var $$$7 = function() {
    return (this.$self("frontBack", 15).$values["Scope"]()($$$6))
}.bind($root);
var $$$8 = function() {
...
var $$$10 = function() {
    return (this.$self("frontBack", 16).$values["Scope"]()($$$9))
}.bind($root);
var $$$11 = function() {
...
$root.$self("var", "frontBack", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        ...
        $returnMulti.push((function() {
            if ($compare(this.$self("str", 6).$substr($$$0.$values["Number"]()), this.$self("str", 6).$substr($primitive("Number", function(value) {
                return function() {
                    return value;
                }
            }(-$$$1.$values["Number"]())).$values["Number"]())).$values["Boolean"]()) {
                return (function() {
                    return this.$self("str", 7);;
                }.bind(this)());
            } else {
                return (function() {
                    return $concat($concat(this.$self("str", 9).$substr($primitive("Number", function(value) {
                        return function() {
                            return value;
                        }
                    }(-$$$2.$values["Number"]())).$values["Number"]()), this.$self("str", 9).$substr($$$3.$values["Number"](), $primitive("Number", function(value) {
                        return function() {
                            return value;
                        }
                    }(-$$$4.$values["Number"]())).$values["Number"]()), 9), this.$self("str", 9).$substr($$$5.$values["Number"]()), 9);;
                }.bind(this)());
            }
        }.bind(this)()));
        var $i = 0,
