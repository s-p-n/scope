...
var $$$1 = function() {
    return (this.$self("frontBack").$values["Scope"]()($$$0))
}.bind($root);
var $$$2 = function() {
...
var $$$4 = function() {
    return (this.$self("frontBack").$values["Scope"]()($$$3))
}.bind($root);
var $$$5 = function() {
...
var $$$7 = function() {
    return (this.$self("frontBack").$values["Scope"]()($$$6))
}.bind($root);
var $$$8 = function() {
...
var $$$10 = function() {
    return (this.$self("frontBack").$values["Scope"]()($$$9))
}.bind($root);
var $$$11 = function() {
    return (print.$values["Scope"]()($$$10()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "frontBack", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp;
        ...
        this.$arg("str", "$$$6", arguments[0]);
        /* Begin ControlCode: 1 */
        if (typeof $returnMulti === "undefined") {
            var $returnMulti = [];
        }
        $returnMulti.push((function() {
            if ($compare(this.$self("str").$substr($$$0.$values["Number"](), $$$0.$values["Number"]()), this.$self("str").$substr($primitive("Number", function(value) {
                return function() {
                    return value;
                }
            }(-$$$1.$values["Number"]())).$values["Number"](), $primitive("Number", function(value) {
                return function() {
                    return value;
                }
            }(-$$$1.$values["Number"]())).$values["Number"]())).$values["Boolean"]()) {
                return (function() {
                    return this.$self("str");;
                }.bind(this)());
            } else {
                return (function() {
                    return $concat($concat(this.$self("str").$substr($primitive("Number", function(value) {
                        return function() {
                            return value;
                        }
                    }(-$$$2.$values["Number"]())).$values["Number"](), $primitive("Number", function(value) {
                        return function() {
                            return value;
                        }
                    }(-$$$2.$values["Number"]())).$values["Number"]()), this.$self("str").$substr($$$3.$values["Number"](), $primitive("Number", function(value) {
                        return function() {
                            return value;
                        }
                    }(-$$$4.$values["Number"]())).$values["Number"]()), 9), this.$self("str").$substr($$$5.$values["Number"](), $$$5.$values["Number"]()), 9);;
                }.bind(this)());
            }
        }.bind(this)()));
        var $i = 0,
