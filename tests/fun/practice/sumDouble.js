...
var $$$2 = function() {
    return (this.$self("sumDouble").$values["Scope"]()($$$0, $$$1))
}.bind($root);
var $$$3 = function() {
...
var $$$6 = function() {
    return (this.$self("sumDouble").$values["Scope"]()($$$4, $$$5))
}.bind($root);
var $$$7 = function() {
...
var $$$10 = function() {
    return (this.$self("sumDouble").$values["Scope"]()($$$8, $$$9))
}.bind($root);
var $$$11 = function() {
    return (print.$values["Scope"]()($$$10()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "sumDouble", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp;
        $$$0 = $primitive('Number', function() {
            return 4
        }.bind(this));
        ...
        this.$arg("a", "$$$1", arguments[0]);
        this.$arg("b", "$$$2", arguments[1]);
        /* Begin ControlCode: 1 */
        if (typeof $returnMulti === "undefined") {
            var $returnMulti = [];
        }
        $returnMulti.push((function() {
            if ($compare(this.$self("a"), this.$self("b")).$values["Boolean"]()) {
                return (function() {
                    return $Math.multiply(this.$self("a"), $$$0);;
                }.bind(this)());
            } else {
                return (function() {
                    return $Math.add(this.$self("a"), this.$self("b"));;
                }.bind(this)());
            }
        }.bind(this)()));
        var $i = 0,
