...
var $$$1 = function() {
    return (this.$self("last2", 21).$values["Scope"]()($$$0))
}.bind($root);
var $$$2 = function() {
...
var $$$4 = function() {
    return (this.$self("last2", 22).$values["Scope"]()($$$3))
}.bind($root);
var $$$5 = function() {
...
var $$$7 = function() {
    return (this.$self("last2", 23).$values["Scope"]()($$$6))
}.bind($root);
var $$$8 = function() {
    return (print.$values["Scope"]()($$$7()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "last2", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp, $val;
        ...
        var $$$4 = function() {
            return (len.$values["Scope"]()(this.$self("str", 11)))
        }.bind(this);
        ...
        this.$arg("str", "$$$10", arguments[0]);
        /* Begin ControlCode: 1 */
        this.$self("var", "last2Chars", $concat(this.$self("str", 8).$substr($primitive("Number", function(value) {
            return function() {
                return value;
            }
        }(-$$$0.$values["Number"]())).$values["Number"]()), this.$self("str", 8).$substr($primitive("Number", function(value) {
            return function() {
                return value;
            }
        }(-$$$1.$values["Number"]())).$values["Number"]()), 8));
        this.$self("var", "i", $$$2);
        this.$self("var", "result", $$$3);
        (function() {
            while ($primitive("Boolean", function(val) {
                return function() {
                    return val;
                }
            }(this.$self("i", 11).$values["Number"]() < $Math.subtract($$$4(), $$$5).$values["Number"]())).$values["Boolean"]()) {
                (function() {
                    return (function() {
                        this.$self("result", 12).$values["Number"] = function(val) {
                            return function() {
                                return val;
                            }
                        }(this.$self("result", 12).$values["Number"]() + (function() {
                            if ($compare(this.$self("str", 12).$substr(this.$self("i", 12).$values["Number"](), $Math.add($$$6, ((function() {
                                this.$self("i", 12).$values["Number"] = function(val) {
                                    return function() {
                                        return val;
                                    }
                                }(this.$self("i", 12).$values["Number"]() + $$$7.$values["Number"]());
                                return this.$self("i", 12);
                            }.call(this)))).$values["Number"]()), this.$self("last2Chars", 12)).$values["Boolean"]()) {
                                return (function() {
                                    return $$$8;;
                                }.bind(this)());
                            } else {
        ...
        $returnMulti.push(this.$self("result", 18));
        var $i = 0,
            $j = 0,
