...
var $$$1 = function() {
    return (this.$self("front3", 5).$values["Scope"]()($$$0))
}.bind($root);
var $$$2 = function() {
...
var $$$4 = function() {
    return (this.$self("front3", 6).$values["Scope"]()($$$3))
}.bind($root);
var $$$5 = function() {
...
var $$$7 = function() {
    return (this.$self("front3", 7).$values["Scope"]()($$$6))
}.bind($root);
var $$$8 = function() {
...
var $$$10 = function() {
    return (this.$self("front3", 8).$values["Scope"]()($$$9))
}.bind($root);
var $$$11 = function() {
...
var $$$13 = function() {
    return (this.$self("front3", 9).$values["Scope"]()($$$12))
}.bind($root);
var $$$14 = function() {
...
$root.$self("var", "front3", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        ...
        $returnMulti.push($concat($concat(this.$self("str", 3).$substr($$$0.$values["Number"](), $$$1.$values["Number"]()), this.$self("str", 3).$substr($$$2.$values["Number"](), $$$3.$values["Number"]()), 3), this.$self("str", 3).$substr($$$4.$values["Number"](), $$$5.$values["Number"]()), 3));
        var $i = 0,
            $j = 0,
