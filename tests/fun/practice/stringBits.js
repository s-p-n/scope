...
var $$$1 = function() {
    return (this.$self("stringBits", 16).$values["Scope"]()($$$0))
}.bind($root);
var $$$2 = function() {
    return (print.$values["Scope"]()($$$1()))
}.bind($root);; /* Begin ControlCode: 0 */
$root.$self("var", "stringBits", /* Starting Scope:1 */ $primitive("Scope", function() {
    return function() {
        var $returnMulti = [],
            $temp, $val;
        ...
        var $$$2 = function() {
            return (len.$values["Scope"]()(this.$self("str", 9)))
        }.bind(this);
        ...
        (function() {
            ...
            }(this.$self("i", 9).$values["Number"]() < $$$2().$values["Number"]())).$values["Boolean"]()) {
                (function() {
                    (function(val) {
                        this.$self("result", 10).$types = Object.create(val.$types);
                        this.$self("result", 10).$values = Object.create(val.$values);
                        return this.$self("result", 10);
                    }.call(this, $concat(this.$self("result", 10), this.$self("str", 10).$substr(this.$self("i", 10).$values["Number"]()), 10)));
                    return this.$self("i", 11).$values["Number"] = function(val) {
                        return function() {
                            return val;
                        }
                    }(this.$self("i", 11).$values["Number"]() + $$$3.$values["Number"]());;;
        ...
        $returnMulti.push(this.$self("result", 13));
        var $i = 0,
            $j = 0,
